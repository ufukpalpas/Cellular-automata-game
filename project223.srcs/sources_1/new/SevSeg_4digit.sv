...
4'd10 : sseg_LEDs = 7'b0001000; //to display 10 A
4'd11 : sseg_LEDs = 7'b0000011; //to display 11 b
4'd12 : sseg_LEDs = 7'b1000110; //to display 12 C
4'd13 : sseg_LEDs = 7'b0100001; //to display 13 d
4'd14 : sseg_LEDs = 7'b0000110; //to display 14 E
4'd15 : sseg_LEDs = 7'b0001110; //to display 15 F
