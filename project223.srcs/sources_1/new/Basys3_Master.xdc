...
set_property PACKAGE_PIN W15 [get_ports {as[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {as[0]}]
set_property PACKAGE_PIN V15 [get_ports {as[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {as[1]}]
set_property PACKAGE_PIN W14 [get_ports {en}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {en}]
set_property PACKAGE_PIN W13 [get_ports {swt[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swt[0]}]
set_property PACKAGE_PIN V2 [get_ports {swt[1]}]					
...
set_property PACKAGE_PIN R2 [get_ports {get}]					
...
set_property PACKAGE_PIN V7 [get_ports Z7]							
	set_property IOSTANDARD LVCMOS33 [get_ports Z7]
...
set_property PACKAGE_PIN U17 [get_ports btnRst]						
